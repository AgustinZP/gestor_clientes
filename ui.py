...
class CreateClientWindow(Toplevel, CenterWidgetMixin):
    ...
    def build(self):
        ...
        Label(frame, text='DNI (2 ints y un upper char)').grid(row=0, column=0)
    ...
    def validate(self, event, index):
        ...
        # Las 3 lineas de abajo son lo mismo que todo el código de abajo comentado
...
class EditClientWindow(Toplevel, CenterWidgetMixin):
    def __init__(self, parent):
        ...
        self.build()
        self.center()
        # Siempre estará por delante de la ventana principal [parent].
        self.transient(parent)
        # El usuario no pueda interactuar con la ventana parent hasta que cierre o termine de interactuar con la ventana emergente
        self.grab_set()
    ...
    def build(self):
        ...
        # Este Label es para dejar espacio entre los botones
        Label(frame, text="").grid(row=0, column=1)
        Button(frame, text="Cancelar", command=self.close).grid(row=0, column=2)
    ...
    def validate(self, event, index):
        ...
        # Cambiar el estado del boton en base a las validaciones
        self.validaciones[index] = valido
        # Si se cumplen las validaciones el boton actualizar se activa
...
class MainWindow(Tk, CenterWidgetMixin):
    ...
    def build(self):
        ...
        Button(frame, text='Borrar', command=self.delete).grid(row=0, column=4)
